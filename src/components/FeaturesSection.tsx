...
const FeatureCard: React.FC<{ feature: Feature }> = ({ feature }) => (
    <div className="bg-brand-light-dark p-6 rounded-lg text-center border border-slate-700/50 h-full">
...
const FeaturesSection: React.FC = () => {
    return (
        <section id="ozellikler" className="min-h-screen flex flex-col justify-center py-20">
